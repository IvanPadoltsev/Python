...
class Results:
    def __init__(self, victories, draws, loses):
...
class Football(Results):
    ...
    def number_of_losses(self):
        return print(f"Футбольных поражений: {self.loses}")
    
    def total_points(self):
        result = 3 * self.victories + self.draws
        return print(f"Общее количество очков: {result}")
...
class Hockey(Results):
    ...
    def number_of_losses(self):
        return print(f"Хоккейных поражений: {self.loses}")
    
    def total_points(self):
        result = 2 * self.victories + self.draws
        return print(f"Общее количество очков: {result}")
