# На вход функции get_size() может поступить пустая строка или пустой словарь. Это вызовет исключение IndexError или KeyError. 
# Нужно обработать их так, чтобы программа выводила текст Произошла ошибка *ТипОшибки.* Узнать размер нельзя!.
